    ...
    public class MainActivity extends AppCompatActivity {
        ...
        private ArrayList<HeroItems> list;
         ...
         */
             ...
             */
                ...
                list.addAll(HeroData.getHeroData());
                showRecyclerList();
             ...
             */
                ...
                ArrayList<HeroItems> stateList = savedInstanceState.getParcelableArrayList(STATE_LIST);
        ...
        private void showSelectedHero(HeroItems hero) {
            Toast.makeText(this, "Kamu memilih " + hero.getName(), Toast.LENGTH_SHORT).show();
        }

        private void showRecyclerList() {
            rvCategory.setLayoutManager(new LinearLayoutManager(this));
            HeroAdapter listHeroAdapter = new HeroAdapter(this);
            listHeroAdapter.setItemHero(list);
        ...
        private void showRecyclerGrid() {
            ...
            GridAdapter gridHeroAdapter = new GridAdapter(this);
        ...
        private void showRecyclerCardView() {
            rvCategory.setLayoutManager(new LinearLayoutManager(this));
            CardAdapter cardViewHeroAdapter = new CardAdapter(this);
